...
| 段 | 秒単価 | 工数倍率 | 含まれるもの |
|----|-------:|---------:|--------------|
| 梅 標準 | ¥3,500 | ×1.0 | 720p ／ 1カット2回まで生成 ／ 音声はモデル同時生成 ／ 16:9 |
| 竹 上 | ¥4,900 | ×1.4 | 1080p ／ 3〜4回生成 ／ 音声を別生成して差し替え ／ 16:9＋9:16 |
| 松 特上 | ¥6,650 | ×1.9 | 1080p〜4K の上位モデル ／ 5回以上生成 ／ 声を選定調整 ／ 高解像度化・ちらつき除去 ／ 16:9＋9:16＋1:1 |
...
### 段の中身は Higgsfield の設定項目そのもの

「綺麗さ」ではなく、使うモデル・解像度・生成回数・納品形式で分けてある。
